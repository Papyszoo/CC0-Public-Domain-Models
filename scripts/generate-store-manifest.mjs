...
const KEYWORD_CATEGORIES = [
  ...
  [['acorn', 'leaf', 'rock', 'boulder', 'tree', 'branch', 'log', 'stump', 'mushroom', 'flower', 'plant', 'bush', 'grass', 'vine', 'pinecone', 'seashell', 'shell', 'coral', 'stone', 'pebble', 'stick', 'twig', 'root', 'cactus', 'fern', 'moss', 'lily', 'pad', 'firewood', 'crystal', 'gem', 'emerald', 'diamond', 'dirt', 'snow', 'snowflake', 'seaweed', 'stake', 'river', 'water', 'coast', 'forest', 'terrain'], 'Nature'],
  [['dog', 'cat', 'fish', 'bird', 'horse', 'cow', 'pig', 'sheep', 'chicken', 'duck', 'rabbit', 'frog', 'snake', 'rattlesnake', 'spider', 'deer', 'bull', 'stag', 'boar', 'bone', 'skull?animal', 'antler', 'horn', 'feather', 'egg?nest', 'wing', 'tooth', 'claw', 'fang', 'skeleton', 'skull', 'bat', 'ghost', 'creature', 'monster'], 'Creatures & Animals'],
  [['car', 'truck', 'boat', 'ship', 'cart', 'wagon', 'wheel', 'tire', 'tyre', 'bicycle', 'bike', 'motorcycle', 'plane', 'helicopter', 'canoe', 'kayak', 'sled', 'anchor', 'oar', 'paddle?boat', 'rudder', 'propeller', 'skiff', 'cartwheel', 'wheelchair', 'hubcap', 'glider', 'traffic', 'guard', 'rover', 'vehicle', 'van', 'taxi', 'bus', 'train', 'capsule', 'spacetruck', 'lander', 'trailer'], 'Vehicles'],
  [['human', 'male', 'female', 'mannequin', 'peg_person', 'character', 'knight', 'mage', 'rogue', 'barbarian', 'adventurer'], 'Characters'],
  [['vase', 'statue', 'sculpture', 'picture', 'frame', 'painting', 'banner', 'flag', 'trophy', 'ornament', 'figurine', 'candelabra', 'chandelier', 'wreath', 'garland', 'ribbon', 'speech', 'sign', 'signpost', 'plaque', 'pedestal', 'plinth', 'birdhouse', 'wind_chime', 'gnome', 'symbol', 'logo', 'icon', 'bead', 'knot', 'star', 'fleur', 'urn', 'obelisk', 'crescent', 'moon', 'sun', 'sundial', 'poster', 'planter', 'pottery', 'brazier', 'tombstone', 'gravestone', 'coffin', 'crypt', 'fountain', 'monument'], 'Decorative'],
