...
const KEYWORD_CATEGORIES = [
  ...
  [['dog', 'cat', 'fish', 'bird', 'horse', 'cow', 'pig', 'sheep', 'chicken', 'duck', 'rabbit', 'frog', 'snake', 'rattlesnake', 'spider', 'deer', 'bull', 'stag', 'boar', 'bone', 'skull?animal', 'antler', 'horn', 'feather', 'egg?nest', 'wing', 'tooth', 'claw', 'fang', 'skeleton', 'skull', 'bat', 'ghost', 'creature', 'monster', 'alien', 'pet'], 'Creatures & Animals'],
  [['car', 'truck', 'boat', 'ship', 'cart', 'wagon', 'wheel', 'tire', 'tyre', 'bicycle', 'bike', 'motorcycle', 'plane', 'helicopter', 'canoe', 'kayak', 'sled', 'anchor', 'oar', 'paddle?boat', 'rudder', 'propeller', 'skiff', 'cartwheel', 'wheelchair', 'hubcap', 'glider', 'traffic', 'guard', 'rover', 'vehicle', 'van', 'taxi', 'bus', 'train', 'capsule', 'spacetruck', 'lander', 'trailer', 'ambulance', 'firetruck', 'police', 'tractor', 'chassis', 'cockpit', 'craft', 'ufo', 'rocket', 'speeder', 'race'], 'Vehicles'],
  [['human', 'male', 'female', 'mannequin', 'peg_person', 'character', 'knight', 'mage', 'rogue', 'barbarian', 'adventurer', 'astronaut', 'survivor', 'pirate', 'worker'], 'Characters'],
  [['vase', 'statue', 'sculpture', 'picture', 'frame', 'painting', 'banner', 'flag', 'trophy', 'ornament', 'figurine', 'candelabra', 'chandelier', 'wreath', 'garland', 'ribbon', 'speech', 'sign', 'signpost', 'plaque', 'pedestal', 'plinth', 'birdhouse', 'wind_chime', 'gnome', 'symbol', 'logo', 'icon', 'bead', 'knot', 'star', 'fleur', 'urn', 'obelisk', 'crescent', 'moon', 'sun', 'sundial', 'poster', 'planter', 'pottery', 'brazier', 'tombstone', 'gravestone', 'coffin', 'crypt', 'fountain', 'monument', 'cross', 'altar'], 'Decorative'],
